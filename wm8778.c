...
/*DAC Control*/
inline uint16_t DAC_C1(uint8_t DZCEN, uint8_t ATC, uint8_t IZD,
...
inline uint16_t DAC_IC(uint8_t DACFMT, uint8_t DACLRP,
...
inline uint16_t ADC_IC(uint8_t ADCFMT, uint8_t ADCLRP, uint8_t ADCBCP,
...
/*Master Mode Control*/
inline uint16_t MMC(uint8_t ADCRATE, uint8_t ADCOSR, uint8_t DACRATE,
...
/*PWR Down Control*/
inline uint16_t PWR_C(uint8_t PDWN, uint8_t ADCPD,
